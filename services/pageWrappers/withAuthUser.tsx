...
export default (ComposedComponent: any) => {
  ...
  WithAuthUserComp.getInitialProps = async (ctx: NextPageContext | any) => {
    const { req, res } = ctx;
    ...
    if (typeof window === "undefined") {
      ...
      AuthUserInfo = createAuthUserInfo({
        firebaseUser: req?.session ? req.session.decodedToken : null,
    ...
    ctx = {
      ...ctx,
      myCustomData: { ...ctx.myCustomData, AuthUserInfo: AuthUserInfo }
    };
